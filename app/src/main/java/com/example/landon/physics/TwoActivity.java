...
public class TwoActivity extends AppCompatActivity {
    ...
    public void twoClick(View v) {
        ...
        if (s0Text.getText().toString().equals("") == false) {
        ...
        if (sfText.getText().toString().equals("") == false) {
